        ...
        <div class="col-sm-3 col-md-3 col-lg-3" >
            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <asp:LinkButton ID="btnStepTwo" runat="server" CssClass="active-link" OnClick="btnStepTwo_Click" >Step Two<p>City,Employee Types </p></asp:LinkButton>
                    </li>
                    <li>
        ...
        <div class="col-sm-9 col-md-9 col-lg-9">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <hr />
                        <div class="row">
                             <div class="filterHeader"><span class="FilterNameHeading">Employee Types</span>
                            ...
                            <asp:GridView ID="GridViewEmployeeType" runat="server" Width="350px" AutoGenerateColumns="False" PagerStyle-CssClass="pgr" CssClass="Grid"                              GridLines="None" AllowPaging="True" AllowSorting="True"                                                OnPageIndexChanging="GridViewEmployeeType_PageIndexChanging" BorderColor="#0094FF" BorderStyle="None" OnRowDataBound="GridViewEmployeeType_RowDataBound" ShowFooter="True" BorderWidth="1px"  >
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <%--<asp:CheckBox ID="CheckAll" runat="server" />--%>
                                            <input style="margin-left:6px" id="chkAll" onclick="javascript: SelectAllCheckboxes(this, 'GridViewEmployeeType');" 
                                            runat="server" type="checkbox" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox style="margin-left:6px"  ID="CheckOne" runat="server" />
