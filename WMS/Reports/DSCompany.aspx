<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DSCompany.aspx.cs" Inherits="WMS.Reports.DSCompany" %>
         ...
         <div class="report-filter">
             <div style="height:20px;"></div>
                ...
                <div style="margin-left:10px">
                    <div><asp:RadioButton GroupName="report"  ID="rb1" runat="server" ForeColor="White" Font-Size="14" Text ="Strength Report" /></div>
                    <div><asp:RadioButton GroupName="report" ID="rb2" runat="server" ForeColor="White" Font-Size="14" Text ="Work Times" /></div>
                    <div><asp:RadioButton GroupName="report" ID="rb3" runat="server" ForeColor="White" Font-Size="14" Text ="Consolidated" /></div>
                </div>
